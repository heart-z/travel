...
import {initialize,findTrip,saveTrip,state,notify,go,canEditTrip} from '../../state';import {today} from '../../domain/dates';import {createTrip,updateTrip} from '../../domain/trips';import {parseCents} from '../../domain/money';
...
<button class="primary section" :loading="state.busy" :disabled="state.busy||!canEditTrip(id)||!state.ready" @click="save">{{id?'保存旅行':'创建旅行 →'}}</button></view></view></template>
